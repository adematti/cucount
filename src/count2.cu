...
__device__ void inline set_angular_bounds(FLOAT *sposition, int *bounds) {
    FLOAT cth, phi;
    int icth, iphi;
...
__device__ void inline set_cartesian_bounds(FLOAT *position, int *bounds) {
...
__device__ int get_interp_bin_index(
    FLOAT x,
    const FLOAT *sep,
    int nsep,
    FLOAT *frac)
